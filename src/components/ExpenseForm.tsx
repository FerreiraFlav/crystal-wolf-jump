    ...
    <Card className="bg-white border-slate-200/80 shadow-sm rounded-2xl overflow-hidden">
      ...
      <CardContent className="pt-4">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* Descrição */}
          <div className="space-y-1.5">
            <Label htmlFor="description" className="text-xs font-semibold text-slate-700">{t('description')}</Label>
            <div className="relative">
          ...
          {/* Categoria */}
          <div className="space-y-1.5">
            <Label htmlFor="category" className="text-xs font-semibold text-slate-700">{t('category')}</Label>
            <div className="relative">
          ...
          {/* Data */}
          <div className="space-y-1.5">
            <Label htmlFor="date" className="text-xs font-semibold text-slate-700">{t('date')}</Label>
            <div className="relative">
